...
export const metadata: Metadata = {
    title: "Privacy Policy — X App | Tom Dowling",
    description:
        "Privacy Policy for the X (Twitter) Application: how information is collected, used, and shared when you use our App to post content to X.",
    openGraph: {
        title: "Privacy Policy — X App | Tom Dowling",
        description:
            "Privacy Policy for the X (Twitter) Application: how information is collected, used, and shared when you use our App to post content to X.",
        url: "https://digital-space.io/terms/x",
...
export default function XPrivacyPolicyPage() {
    return (
                ...
                <div className="container mx-auto px-4 md:px-6 max-w-3xl">
                    <div className="space-y-8 text-foreground/90 leading-relaxed">
                        <p>
                            ...
                            use our X Application (the &quot;App&quot;) to post content to X, formerly known as Twitter.
                        ...
                        <div>
                            ...
                            <p className="mb-3">
                                When you use the App to post to X, we may access certain information from your X account
                                via the X API. This includes:
                            </p>
                            <ul className="list-disc pl-6 space-y-2">
                                <li>
                                    <strong className="text-foreground">Public Profile Information:</strong> Username,
                                    display name, profile picture, and user ID.
                                </li>
                                <li>
                                    <strong className="text-foreground">Permissions:</strong> We request specific OAuth
                                    2.0 scopes (for example,{" "}
                                    <code className="text-sm bg-background px-1 py-0.5 rounded">tweet.write</code>,{" "}
                                    <code className="text-sm bg-background px-1 py-0.5 rounded">tweet.read</code>,{" "}
                                    <code className="text-sm bg-background px-1 py-0.5 rounded">users.read</code>,{" "}
                                    <code className="text-sm bg-background px-1 py-0.5 rounded">offline.access</code>)
                                ...
                                <li>
                                    ...
                                    refresh tokens issued by X, which allow the App to act on your behalf. We never
                                    receive or store your X password.
                                </li>
                                <li>
                        ...
                        <div>
                                    ...
                                    <tbody>
                                        <tr className="border-b">
                                            ...
                                            <td className="px-4 py-3">
                                                To allow you to create, schedule, and manage posts on your X account.
                                            </td>
                                        </tr>
                                        <tr className="border-b">
                                            <td className="px-4 py-3 align-top font-medium">Authentication</td>
                                            <td className="px-4 py-3">
                                                To verify your identity via X OAuth and to refresh your session so
                                                scheduled posts continue to publish.
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <p className="mt-4">
                                We do not use X content or metrics to train machine learning models, and we do not build
                                advertising or marketing profiles from it.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li>
                                    <strong className="text-foreground">With X:</strong> Information is sent to X servers
                                    to execute the posting functionality.
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                services. You can revoke access at any time in your X Settings under &quot;Security and
                                account access&quot; then &quot;Apps and sessions,&quot; which immediately stops all
                                further access. For full instructions on removing your data, see our{" "}
                                <Link
