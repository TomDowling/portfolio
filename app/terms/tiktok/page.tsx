...
export const metadata: Metadata = {
    title: "Privacy Policy — TikTok App | Tom Dowling",
    description:
        "Privacy Policy for the TikTok Application: how information is collected, used, and shared when you use our App to post content to TikTok.",
    openGraph: {
        title: "Privacy Policy — TikTok App | Tom Dowling",
        description:
            "Privacy Policy for the TikTok Application: how information is collected, used, and shared when you use our App to post content to TikTok.",
        url: "https://digital-space.io/terms/tiktok",
...
export default function TikTokPrivacyPolicyPage() {
    return (
                ...
                <div className="container mx-auto px-4 md:px-6 max-w-3xl">
                    <div className="space-y-8 text-foreground/90 leading-relaxed">
                        <p>
                            ...
                            use our TikTok Application (the &quot;App&quot;) to post content to TikTok. By using the
                        ...
                        <div>
                            ...
                            <p className="mb-3">
                                When you use the App to post to TikTok, we may access certain information from your
                                TikTok account via TikTok&apos;s APIs. This includes:
                            </p>
                            <ul className="list-disc pl-6 space-y-2">
                                ...
                                <li>
                                    <strong className="text-foreground">Permissions:</strong> We request the permissions
                                    required to perform the posting actions you initiate (for example, publishing content
                                    on your behalf where applicable).
                                </li>
                                <li>
                                    <strong className="text-foreground">Content:</strong> The text, images, videos, or
                                    links you specifically choose to post through the App.
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <tbody>
                                        <tr className="border-b">
                                            ...
                                            <td className="px-4 py-3">
                                                To allow you to create and manage posts or uploads on your TikTok account
                                                as supported by the App.
                                            </td>
                                        </tr>
                                        <tr className="border-b">
                                            <td className="px-4 py-3 align-top font-medium">Authentication</td>
                                            <td className="px-4 py-3">
                                                To verify your identity via TikTok Login to ensure only you can post to
                                                your account.
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-6 space-y-2">
                                <li>
                                    <strong className="text-foreground">With TikTok:</strong> Information is sent to
                                    TikTok servers to execute the posting functionality.
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                security practices in line with TikTok&apos;s platform requirements to ensure your data
                                is handled securely during the posting process.
                            </p>
                        </div>
